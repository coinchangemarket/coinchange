...
const uint64_t DEFAULT_DUST_THRESHOLD                        = uint64_t(1000000);
...
const char     CRYPTONOTE_NAME[]                             = "CoinChange";
...
const char* const SEED_NODES[] = { "seed1.coinchangemarket.com:18080", "seed2.coinchangemarket.com:18080" };
